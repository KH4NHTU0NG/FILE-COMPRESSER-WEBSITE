...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-background text-white selection:bg-primary-500 selection:text-white pb-20 relative overflow-hidden font-sans">
      ...
      {/* Main Container */}
      <div className="max-w-6xl mx-auto px-4 pt-12 flex flex-col gap-8 relative z-10">
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/5 pb-6">
          <div>
            ...
            <h1 className="text-3.5xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-primary-400 flex items-center gap-2">
              [TKT] FILE COMPRESSER <Sparkles className="w-6 h-6 text-primary-400 shrink-0" />
            </h1>
            <p className="text-sm text-white/50 mt-1">
              Trình nén PDF và hình ảnh bảo mật cao. Toàn bộ quá trình xử lý diễn ra trực tiếp trên thiết bị của bạn [2].
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          {/* Left Column: Settings and Security Info */}
          <div className="lg:col-span-1 flex flex-col gap-6">
            ...
            <section className="bg-card/30 border border-white/5 rounded-2xl p-5 backdrop-blur-md flex flex-col gap-3">
              <h4 className="text-xs font-bold text-white/90 tracking-wide uppercase">Cam kết Bảo mật & Cơ chế Kỹ thuật</h4>
              <div className="flex flex-col gap-3 text-xs text-white/50">
                <div className="flex flex-col gap-1">
                  <span className="font-semibold text-white/70">Nén ảnh Canvas</span>
                  <span>
                    Hình ảnh được giải mã và vẽ lại trên Canvas mới, tự động xóa siêu dữ liệu EXIF (GPS, thiết bị) [3].
                  </span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="font-semibold text-white/70">Nén & Tẩy Metadata PDF</span>
                  <span>
                    Duyệt qua cấu trúc nhị phân của PDF, tối ưu hóa các luồng ảnh và ghi đè dữ liệu rác (/Info, /Metadata) bằng giá trị rỗng [2, 4].
                  </span>
                </div>
              </div>
            </section>
          ...
          {/* Right Column: Upload Box and Files list */}
